    ...
    <div class="container" style="margin-top:3rem; padding-bottom:9rem;">
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 mb-3">
                <input type="text" class="form-control" placeholder="Procurar pelo nome" wire:model.lazy="nome">
            </div>
            <div class="col-sm-6 mb-3">
                <select class="custom-select" wire:model='pais'>
                    <option value="">Filtrar por país</option>
                    @foreach ($paises as $paiss)
                        <option value="{{ $paiss }}">{{ $paiss }}</option>
                    @endforeach
                  </select>
                  <select class="custom-select" wire:model='categoria'>
                    <option value="">Filtrar por categoria</option>
                    @foreach ($categorias as $categoriass)
                        <option value="{{ $categoriass }}">{{ $categoriass }}</option>
                    @endforeach
                  </select>
            ...
            {{-- <div class="col-md-6 mb-4 d-flex justify-content-md-end mt-md-0 mt-2">
                <button wire:click="aprovados" class="btn btn-primary">Listar aprovados</button>
                <button wire:click="pendentes" class="btn btn-warning">Listar pendentes</button>
                <button wire:click="reprovados" class="btn btn-danger">Listar reprovados</button>
            </div> --}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div style="font-size:17px">
                                                    @if($instituicao->site != null)
                                                        <a target="_blank" href="{{$instituicao->site}}">{{ $instituicao->site }}</a>
                                                    @else
                                                        Não identificado
                                                    @endif
                                                </div>
